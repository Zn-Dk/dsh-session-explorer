...
export const I18N = {
  ...
  'timelineSearchPlaceholder': '搜索标题、目录、消息正文…',
  'timelineAll': '全部',
  'timelineMain': '主代理',
  'timelineChild': '子代理',
  'timelineSort': '排序',
  ...
  'timelineHitJump': '跳转到消息',
  'timelineHitJumpAria': '在会话详情中定位该消息',
  'timelineHitNotFound': '该消息不在当前会话摘要中',
  'timelineToday': '今天',
  ...
  'timelineSearchPlaceholder': 'Search titles, directories, and message bodies…',
  'timelineAll': 'All',
  ...
  'timelineNextSession': 'Next',
  'timelineSessionPosition': '{current} / {total}',
  'timelineHitJump': 'Jump to message',
  'timelineHitJumpAria': 'Locate this message in the session detail',
  'timelineHitNotFound': 'Message not found in this session summary',
  'timelineToday': 'Today',
